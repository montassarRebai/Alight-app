#!/bin/bash
ansible-playbook /root/kube-cluster/initial.yml ;
ansible-playbook /root/kube-cluster/kube-dependencies.yml;
sleep 18
ansible-playbook /root/kube-cluster/master-cluster.yml;
sleep 20
ansible-playbook /root/kube-cluster/workers-cluster.yml;
sleep 20
